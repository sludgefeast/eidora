...
#
# (2) This script is generated from the Gradle source. Any changes should
#     be made to the original, not this derived script.
#
##############################################################################
...
# This is reliable if $PWD is set correctly before calling this script.
